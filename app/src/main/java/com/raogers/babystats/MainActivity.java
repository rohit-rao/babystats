...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private void updateUIForUser(FirebaseUser user) {
        findViewById(R.id.main_login).setVisibility(user == null ? View.VISIBLE : View.GONE);
    }

    private void registerNewUser(FirebaseUser user) {
        // Adds an entry to the "users" object.
        DatabaseReference usersRef = FirebaseDatabase.getInstance().getReference("users");
        DatabaseReference childRef = usersRef.child(user.getUid());

        HashMap<String, Boolean> values = new HashMap<String, Boolean>();
        values.put("registered", true);
